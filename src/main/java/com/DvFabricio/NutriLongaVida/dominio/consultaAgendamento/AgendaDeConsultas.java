...
import com.DvFabricio.NutriLongaVida.dominio.consultaAgendamento.cancelamento.ValidacaoCancelamentoDeConsulta;
import com.DvFabricio.NutriLongaVida.dominio.consultaAgendamento.validacaoConsulta.ValidacaoAgendamentoDeConsulta;
import com.DvFabricio.NutriLongaVida.infra.excecoes.ValidacaoException;
import com.DvFabricio.NutriLongaVida.dominio.entities.nutricionista.Nutricionista;
import com.DvFabricio.NutriLongaVida.dominio.entities.nutricionista.NutricionistaRepository;
...
public class AgendaDeConsultas {
    ...
    private Nutricionista escolherNutricionista(DadosAgendamentoConsulta dados) {
        ...
        return nutricionistaRepository.escolherNutricionistaAleatorioDisponivelNaData(dados.especialidade(), dados.data());
    }
}